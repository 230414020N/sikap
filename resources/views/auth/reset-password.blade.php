...
<div class="w-full max-w-md">
    <div class="mb-6 text-center">
        ...
        <p class="mt-4 text-[11px] font-semibold tracking-widest text-gray-500">RESET PASSWORD</p>
        <h1 class="mt-2 text-2xl font-semibold tracking-tight text-gray-900">Buat Password Baru</h1>
        <p class="mt-1 text-sm text-gray-600">Masukkan password baru untuk akun kamu.</p>
    </div>
    ...
    <div class="bg-white border border-gray-200 rounded-3xl shadow-sm p-6 sm:p-7">
        ...
        <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
            ...
            <div>
                <x-input-label for="password" value="Password Baru" class="text-sm font-medium text-gray-900" />
                <x-text-input
                    id="password"
                    name="password"
                    type="password"
            ...
            <div>
                <x-input-label for="password_confirmation" value="Konfirmasi Password Baru" class="text-sm font-medium text-gray-900" />
                <x-text-input
