    ...
    <div class="min-h-screen bg-gray-50">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div class="flex items-start justify-between gap-6 mb-8">
                <div>
                    <h1 class="text-2xl font-semibold text-gray-900">Edit Pendidikan</h1>
                    <p class="mt-1 text-sm text-gray-600">Perbarui opsi pendidikan.</p>
                </div>
            ...
            <form method="POST" action="{{ route('admin.master.education-levels.update', $item->id) }}"
                ...
                <div class="flex items-center justify-between">
                    <label class="inline-flex items-center gap-2">
                        <input type="checkbox" name="is_active" value="1" class="rounded border-gray-300 text-gray-900 shadow-sm focus:ring-gray-900"
                               @checked(old('is_active', $item->is_active) ? true : false)>
