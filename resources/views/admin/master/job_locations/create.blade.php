    ...
    <div class="min-h-screen bg-gray-50">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div class="flex items-start justify-between gap-6 mb-8">
                <div>
                    <h1 class="text-2xl font-semibold text-gray-900">Tambah Lokasi</h1>
                    <p class="mt-1 text-sm text-gray-600">Buat lokasi untuk lowongan.</p>
                </div>
            ...
            <form method="POST" action="{{ route('admin.master.job-locations.store') }}"
