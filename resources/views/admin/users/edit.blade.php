    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="flex items-start justify-between gap-6 mb-8">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Password boleh dikosongkan.</p>
            </div>
        ...
        <form method="POST" action="{{ route('admin.users.update', $user->id) }}"
                ...
                <div>
                    ...
                    <select name="company_id"
                        ...
                        @foreach($companies as $c)
                            <option value="{{ $c->id }}" @selected((string) old('company_id', $user->company_id) === (string) $c->id)>{{ $c->nama }}</option>
                        @endforeach
                    </select>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label class="text-sm font-medium text-gray-900">Password Baru</label>
                ...
                <div>
                    <label class="text-sm font-medium text-gray-900">Konfirmasi Password Baru</label>
